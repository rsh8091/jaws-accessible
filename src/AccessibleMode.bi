...
Declare Function IsAccessibleJawsOvertimeTestMode% Static
...
Declare Sub AccessiblePrepareJawsOvertimeTest ()
...
Declare Function AccessibleSubstitutionMenu% (humanTeam, returnContext)
Declare Sub AccessibleHalftimeSubstitution ()
