...
| `test-accessible-play-safe.ps1` | Runtime transcript | Two human-controlled players can be set to play safe, each selection is acknowledged, and the menu returns without an empty final announcement |
